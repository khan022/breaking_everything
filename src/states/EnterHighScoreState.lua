...
function EnterHighScoreState:update(dt)
    if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
        ...
        love.filesystem.write('dx_ball.lst', scoreStr)
    ...
    -- scorll through left to right for the characters slots for arcade style name
    ...
    -- scroll through up to down for the characters for arcade style name
...
function EnterHighScoreState:render()
    ...
    -- render all three characters for the initials
